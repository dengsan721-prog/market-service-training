    ...
    <section class="page-shell">
      <div class="content">
        ...
        <section class="band ability-module-card ability-other content-panel" id="abilityFramework" hidden>
          <div class="band-inner">
            <div class="copy-title-row"><h2>市场服务</h2><button type="button" class="mini-copy panel-copy-btn" data-copy-panel="abilityFramework" onclick="copyPanelText(this)">复制</button></div>
        ...
        <section class="band ability-module-card ability-other content-panel" id="abilityThinking" hidden>
          <div class="band-inner">
            <div class="copy-title-row"><h2>总监思维</h2><button type="button" class="mini-copy panel-copy-btn" data-copy-panel="abilityThinking" onclick="copyPanelText(this)">复制</button></div>
        ...
        <section class="band ability-module-card ability-model content-panel" id="modelCollection" hidden>
          <div class="band-inner">
            ...
            <div class="copy-title-row"><h2>先激活情感，再按16问一次性采集完整。</h2><button type="button" class="mini-copy panel-copy-btn" data-copy-panel="modelCollection" onclick="copyPanelText(this)">复制</button></div>
